...
function EditExpense() {
  ...
  const [form, setForm] = useState({
    ...
    date: existingExpense ? toDateInputValue(existingExpense.date) : "",
  });
      ...
      <main className={styles.page}>
        <section className={styles.card}>
          <div className={styles.errorBanner} role="alert">
            No expense data was provided. Please go back to the dashboard and
            click Edit again.
          </div>
  ...
  return (
    <main className={styles.page}>
      <section className={styles.card} aria-labelledby="edit-expense-title">
        <div className={styles.header}>
          <div>
            <p className={styles.eyebrow}>Transactions</p>
            <h1 id="edit-expense-title" className={styles.title}>
              Edit Expense
            </h1>
